...
public class Result
{
    ...
    public static Result<T> Failure<T>(string[] errors) => Result<T>.Failure(errors);
}
...
public class Result<T> : Result
{
    ...
    public new static Result<T> Failure(string[] errors) => new(false, default, errors.FirstOrDefault(), errors);
}
